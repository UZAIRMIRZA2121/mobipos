<header class="topbar">
    ...
    <div class="topbar-right">
      ...
      @endif
      <button class="icon-btn search-toggle" id="globalSearchBtn" title="Search Invoice or Code" onclick="document.getElementById('globalSearchModal').classList.remove('hidden'); setTimeout(() => document.getElementById('globalSearchInput').focus(), 100);">
