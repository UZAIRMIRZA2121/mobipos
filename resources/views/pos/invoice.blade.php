...
<div class="receipt-container">
    ...
    <div class="totals">
        ...
        <div class="info-row" style="margin-top: 5px;">
            <span>Paid:</span>
            <span>PKR {{ number_format($order->paid_amount) }}</span>
        </div>
        <div class="info-row">
            <span>{{ $order->paid_amount > $order->total ? 'Change:' : 'Due:' }}</span>
            <span>PKR {{ number_format($order->due_amount) }}</span>
        </div>
    ...
    <a href="tel:+923086452242">+92 308 6452242</a>
</p>
    </div>
