...
<div class="content-header">
  <div class="header-left">
    ...
    <p class="page-subtitle">Create a new staff member and assign their privileges</p>
  </div>
...
<div class="content-body" style="display: flex; justify-content: center; padding-top: 20px;">
    <div class="card" style="width: 100%; max-width: 800px;">
        ...
        <form action="{{ route('shop.staff.store') }}" method="POST">
            @csrf
            <div class="card-body" style="padding: 24px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        <label class="form-label" for="staff_type">Staff Type / Role (e.g., Cashier, Manager)</label>
                        <input type="text" id="staff_type" name="staff_type" class="form-control" value="{{ old('staff_type') }}" required>
                    </div>
                    <div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    ...
                    <label style="display: flex; align-items: center; gap: 10px; padding: 12px; border: 1px solid var(--border-color); border-radius: 8px; cursor: pointer; transition: all 0.2s ease;">
            ...
            <div class="card-footer" style="padding: 20px 24px; text-align: right; background: var(--bg-color); border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;">
                ...
                <button type="submit" class="btn btn-primary" style="padding: 10px 24px;">Create Staff Member</button>
            </div>
        </form>
    </div>
</div>
