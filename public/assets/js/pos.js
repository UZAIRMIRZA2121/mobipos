  ...
  tbody.innerHTML = cart.map(item =>
    `<tr>
        ...
        <td style="text-align:center">
          ...
          <td style="text-align:right;">
             ${['mobile', 'cosmetics', 'cosmetic'].includes(window.ACTIVE_MODULE) ? `<span style="font-size: 13px; font-weight: 600; color: var(--success);">${item.sub.toFixed(2)}</span>` : `<input type="number" class="input input-sm" style="width: 75px; text-align: right; padding: 2px 4px; height: 26px; font-size: 13px; display: inline-block; font-weight: 600; color: var(--success);" value="${item.sub.toFixed(2)}" onchange="setTotal(${item.prodId}, this.value)" title="Enter Total (Auto-calculates Qty)">`}
          </td>
          <td style="text-align:right">
